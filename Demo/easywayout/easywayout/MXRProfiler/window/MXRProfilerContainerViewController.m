//
//  MXRProfilerContainerViewController.m
//  easywayout
//
...
@interface MXRProfilerContainerViewController ()

@end

CGFloat MXRProfilerRoundPixelValue(CGFloat value)
{
    CGFloat scale = [[UIScreen mainScreen] scale];
    return roundf(value * scale) / scale;
}

@implementation MXRProfilerContainerViewController

{
    UIViewController<MXRProfilerMovableViewController> *_presentedViewController;
...
- (void)presentViewController:(UIViewController<MXRProfilerMovableViewController> *)viewController
                     withSize:(CGSize)size
{
    ...
    CGFloat widthOffset = MXRProfilerRoundPixelValue((CGRectGetWidth(self.view.bounds) - adjustedSize.width) / 2.0);
...
- (void)_pan
{
    ...
    CGFloat centerHeightOffset = MXRProfilerRoundPixelValue(CGRectGetHeight(_presentedViewController.view.frame) / 2.0);
    CGFloat centerWidthOffset = MXRProfilerRoundPixelValue(CGRectGetWidth(_presentedViewController.view.frame) / 2.0);
...
- (void)_pinch:(UIPinchGestureRecognizer *)gestureRecognizer
{
    ...
    CGFloat yOffset = MXRProfilerRoundPixelValue((expectedHeight - CGRectGetHeight(_presentedViewController.view.frame)) / 2.0);
